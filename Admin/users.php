...
<head>
    ...
    <title>Users - ShopNest Admin</title>
        ...
        <div class="row no-gutters">
            ...
            <main class="col-md-10 main-content">
                <div class="header-section">
                    <div>
                        <h3 class="m-0" style="background: var(--primary-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Users</h3>
                        <p class="text-muted mb-0">Manage your store's users.</p>
                    </div>
                ...
                <div class="table-responsive" id="usersContainer">
            ...
            <div class="modal-content">
                <form id="addUserForm" method="POST" action="add_user.php">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="bi-plus-lg mr-2"></i>Add New User</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editUserForm" method="POST" action="update_user.php">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="bi-pencil-square mr-2"></i>Edit User</h5>
                        <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control" id="edit_email" required>
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function () {
            ...
            $("#searchInput").on("keyup", function () {
                ...
                $.ajax({
                    ...
                    error: function () {
                        $("#usersContainer").html("<p>Error loading users.</p>");
                    }
                });
            });

            // Pass user data into edit modal
            ...
            // AJAX form submit for adding user
            ...
            // AJAX form submit for updating user
            ...
            function loadUsers() {
                $.get("users_table.php", function (data) {
                    $("#usersContainer").html(data);
                });
            }
