...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-12"><img src="../images/watches/watch back.jpg" alt="Watches Banner" width="1920" height="640" class="img-fluid"/></div>
    </div>
    <hr>
  </div>
  ...
  <div class="container">
    <div class="row text-center">
      <?php
      include '../db.php';
      $sql = "SELECT * FROM products WHERE category = 'Watches' ORDER BY id DESC";
      ...
      if ($result->num_rows > 0) {
        ...
        echo '<p class="text-center">No watches available.</p>';
      }
      $conn->close();
      ?>
    </div>
