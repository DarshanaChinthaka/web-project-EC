...
<head>
  ...
  <title>ShopNest - Computer Accessories</title>
  <!-- Bootstrap -->
...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-12"><img src="../images/category/b1 (5).jpg" alt="Computer Accessories Banner" width="1920" height="640" class="img-fluid"/></div>
    </div>
    <hr>
  </div>

  <!-- Category Title -->
  <h2 class="text-center">Computer Accessories</h2>
  <hr>
  ...
  <div class="container">
    <div class="row text-center">
      <?php
      include '../db.php';
      $sql = "SELECT * FROM products WHERE category = 'Computer Accessories' ORDER BY id DESC";
      ...
      if ($result->num_rows > 0) {
        ...
        echo '<p class="text-center">No computer accessories available.</p>';
      }
      $conn->close();
      ?>
    </div>
