...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-12"><img src="../images/category/b1 (9).jpg" alt="Cap & Hat Banner" width="1920" height="640" class="img-fluid"/></div>
    </div>
    <hr>
  </div>

  <!-- Category Title -->
  <h2 class="text-center">Cap & Hat</h2>
  <hr>
  ...
  <div class="container">
    <div class="row text-center">
      <?php
      include '../db.php';
      $sql = "SELECT * FROM products WHERE category = 'Cap & Hat' ORDER BY id DESC";
      ...
      if ($result->num_rows > 0) {
        ...
        echo '<p class="text-center">No cap & hat available.</p>';
      }
      $conn->close();
      ?>
    </div>
